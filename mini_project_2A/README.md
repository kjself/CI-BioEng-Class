...
#### Acquire the Data
Whether you use the simulation or the actual micro:bit, run the device such that the state is observed to be `shaken` - `not_shaken` - `shaken` - `not_shaken`, each for 5 seconds.
#### Graph your Data
